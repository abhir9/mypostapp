            ...
            <div className="p-4">
              <form onSubmit={this.handleSubmit} className="clearfix">
                ...
                <div className="form-group">
                  <label htmlFor="exampleFormControlTextarea1">Post on our Portal</label>
                  <textarea onChange={this.handlePostMessage} value={this.state.postMessage} className="form-control"
