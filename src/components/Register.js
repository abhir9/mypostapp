                    ...
                    <div>
                      <form onSubmit={this.handleSubmit}>
                        ...
                        <div className="form-group">
                          ...
                          <input type="text" className="form-control" id="register-firstname"
                                 onChange={this.handleInputChange} value={this.state.firstname} name="firstname"
                        ...
                        <div className="form-group">
                          ...
                          <input type="text" className="form-control" id="register-lastname"
                                 onChange={this.handleInputChange} value={this.state.lastname} name="lastname"
                        ...
                        <div className="form-group">
                          ...
                          <input type="email" className="form-control" id="register-email"
                                 onChange={this.handleInputChange} value={this.state.email} name="email"
                        ...
                        <div className="form-group">
                          ...
                          <input type="password" className="form-control" id="register-password"
                                 onChange={this.handleInputChange} value={this.state.password} name="password"
                        ...
                        <div className="form-group">
                          ...
                          <input type="password" className="form-control" id="register-password-confirmation"
                                 onChange={this.handleInputChange} value={this.state.passwordConfirmation}
                                 name="passwordConfirmation" placeholder="Password"/>
